...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { body: @reply.body, name: @reply.name, post_id: @reply.post_id } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { body: @reply.body, name: @reply.name, post_id: @reply.post_id } }
